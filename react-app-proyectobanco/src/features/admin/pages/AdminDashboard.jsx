    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Registrar retiros de cuentas bancarias</p>
        </div>
        <button className="btn-add" onClick={() => setModal(true)}>
          <svg viewBox="0 0 24 24" fill="none" width="14" height="14">
      ...
      <div className="stats-grid" style={{ marginBottom: '1.25rem' }}>
        {[
          ...
          { label: 'Total retirado (sesión)', value: 'Q ' + fmt(history.reduce((s, r) => s + r.amount, 0)) },
        ].map((s, i) => (
          <div key={i} className="stat-card">
            <div className="stat-card-value" style={{ fontSize: '1.4rem' }}>{s.value}</div>
            <div className="stat-card-label">{s.label}</div>
      ...
      {/* Tabla de historial de sesión */}
      <div className="table-card">
        <div className="table-header">
          <span className="table-title">Retiros registrados en esta sesión</span>
        </div>
        <table className="data-table">
          <thead>
            <tr>
                ...
                <td colSpan={4}>
                  <div className="empty-state">
                    ...
                    <p className="empty-state-text">
                      No hay retiros en esta sesión. Usá el botón "Nuevo retiro" para registrar uno.
                    </p>
                  </div>
                </td>
              </tr>
          ...
          <div className="modal" style={{ maxWidth: 420 }} onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div style={{
                ...
                <p style={{ fontSize: '.78rem', color: 'rgba(224,92,92,0.8)', lineHeight: 1.5, margin: 0 }}>
                  El retiro se aplicará de inmediato al saldo de la cuenta. Esta acción no se puede deshacer.
                </p>
              </div>
